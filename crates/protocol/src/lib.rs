...
pub use wire::{
    ...
    SESSION_AUTH_PROFILE_V1, SessionAuthBootstrapMessage, SessionAuthHello, SessionAuthProofMessage,
    SessionAuthRole, decode_control_envelope, decode_data_stream_open,
