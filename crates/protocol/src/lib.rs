...
pub use wire::{
    ...
    ProtocolWireError, SESSION_AUTH_PROFILE_V1, SessionAuthBootstrapMessage, SessionAuthHello,
    ...
    encode_control_envelope, encode_data_stream_open, encode_pairing_bootstrap,
