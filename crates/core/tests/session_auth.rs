...
fn proofs_sign_exact_role_label_and_transcript_digest_and_derive_golden_session_id() {
    ...
    assert_eq!(
        ...
        [
            ...
            163, 135, 209, 155, 147, 68, 39, 195, 57, 23, 154, 139, 200, 135, 177, 199, 142, 199,
            85, 229, 25, 233, 62, 210, 158, 9, 206, 183, 63, 241, 193, 148, 219, 34, 188, 75, 65,
            134, 208, 94, 178, 50, 130, 13, 39, 14,
        ]
    );
    assert_eq!(
        session_id.to_bytes(),
