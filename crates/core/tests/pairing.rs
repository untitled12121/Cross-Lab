...
fn pairing_transcript_and_confirmations_match_golden_vectors() {
    ...
    let expected_digest = [
        82, 75, 39, 12, 199, 179, 200, 134, 244, 96, 246, 128, 98, 140, 4, 181, 53, 77, 100,
        250, 11, 140, 110, 180, 76, 36, 251, 96, 14, 52, 207, 70,
    ];
    let expected_inviter = [
        91, 2, 96, 118, 92, 175, 212, 42, 72, 105, 132, 77, 137, 100, 56, 26, 92, 134, 225,
        141, 218, 80, 142, 169, 11, 93, 191, 31, 247, 194, 100, 157,
    ];
    let expected_joiner = [
        239, 15, 217, 233, 254, 95, 11, 40, 230, 182, 248, 57, 199, 64, 114, 64, 106, 35, 100,
        224, 43, 178, 222, 187, 62, 32, 154, 161, 235, 132, 187, 217,
    ];
