...
fn authority_delegation_v1_golden_vector() {
    ...
    assert_eq!(
        ...
        [
            107, 234, 244, 210, 203, 95, 220, 252, 211, 183, 10, 139, 93, 40, 134, 187, 146, 166,
            17, 215, 201, 30, 112, 29, 237, 49, 124, 156, 17, 134, 92, 180, 19, 61, 36, 46, 54, 32,
            184, 119, 184, 64, 54, 223, 245, 234, 77, 65, 167, 160, 83, 165, 155, 222, 120, 114,
            89, 4, 37, 219, 252, 108, 110, 7,
        ]
    );
}
...
fn device_credential_v1_golden_vector() {
    ...
    assert_eq!(
        ...
        [
            217, 46, 183, 183, 96, 199, 184, 32, 167, 4, 233, 125, 230, 53, 106, 98, 161, 251, 230,
            11, 243, 14, 173, 21, 62, 123, 68, 100, 217, 9, 123, 252, 36, 219, 166, 30, 78, 23,
            222, 105, 26, 141, 242, 95, 27, 39, 73, 54, 144, 235, 152, 113, 22, 186, 47, 248, 180,
            146, 10, 239, 158, 178, 250, 0,
        ]
    );
}
