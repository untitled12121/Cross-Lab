...
fn authority_delegation_v1_golden_vector() {
    ...
    assert_eq!(
        ...
        [
            83, 1, 126, 178, 114, 48, 121, 92, 42, 38, 56, 246, 9, 253, 198, 138, 172, 47,
            139, 250, 138, 5, 1, 248, 42, 239, 185, 255, 75, 238, 185, 106,
        ]
    );
...
fn device_credential_v1_golden_vector() {
    ...
    assert_eq!(
        ...
        [
            207, 25, 126, 225, 229, 238, 172, 144, 202, 155, 222, 239, 248, 43, 13, 116, 169,
            33, 235, 115, 24, 36, 173, 237, 192, 83, 205, 67, 249, 139, 208, 253,
        ]
    );
